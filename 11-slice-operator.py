...
# 4. Last element
print(fruits[:-1]) # uzima sve OSIM zadnjeg elementa (bilo da radimo sa listama ili stringovima)
print(text[:-5]) # Dobijamo "Hi there, I like P"; dakle, uklonjeno je tacno 5 zadnjih karaktera