file = open("1basic-testfile-reading.txt", "r")
f = file.readlines()
print(
    f
)  # ['Test text in a file called testfile.txt!\n', '\n', 'Third line...\n', '\n', '\n', '6th line...']
...
for line in f:
    if (
        ...
        newList.append(
            line
        )  # dodajemo poslenji element, koji smo izuzeli sa 'if' izrazom jer nije imao simbol '\n'
